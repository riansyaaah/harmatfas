        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-heading">
                    DATA KEKUATAN - RENCANA ANGGARAN HARWAT BERDASARKAN NORMA INDEK
                </div>
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                         <form id="myForm" name="simpleForm" novalidate id="simpleForm" action="<?php echo base_url(); ?>kekuatanhar/data/<?php echo $id;?>" method="post">
                                        <div class="row">
                    ...
                    <tbody id="grid">
                        <?php $no = 1; foreach($kekuatan as $get){?>
                                        <tr>
                                            ...
                                            <td style="text-align:right;"><?php echo $get['kekuatanhar']; ?></td>
                                            <?php }else{ ?>
										    <td style="text-align:right;" contenteditable="true" onBlur="saveToDatabasekelompok(this,'kekuatanhar','<?php echo $get['kode']; ?>')" onClick="showEdit(this);"><?php echo $get['kekuatanhar']; ?></td>
    ...
    <script>
		...
		function saveToDatabasekelompok(editableObj,column,id) {
            ...
            if(checkConnection == true){
                $.ajax({
                    url: "<?php echo base_url();?>kekuatanhar/updatekekuatanhar",
                    type: "POST",
