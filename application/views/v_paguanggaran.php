        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-heading">
                    DATA PAGU ANGGARAN - TAHUN SEBELUMNYA 
                </div>
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form id="myForm" name="simpleForm" novalidate id="simpleForm" action="<?php echo base_url(); ?>paguanggaran" method="post">
                                        <div class="row">
        ...
        <div class="hpanel hgreen">
            <div class="panel-body">
                ...
                <table cellpadding="1" cellspacing="1" class=" tableSection table table-bordered table-striped">
                    ...
                    <tbody id="grid">
                        <?php $no = 1; foreach($paguanggaran as $get){?>
                                        <tr>
                                            <td><?php echo $get['uraian']; ?></td>
                                            <td><?php echo $get['satuan']; ?></td>
										    <td><?php echo $get['matauang']; ?></td>	
										    <td style="text-align:right;" contenteditable="true" onBlur="saveToDatabasekelompok(this,'paguanggaran','<?php echo $get['kode']; ?>')" onClick="showEdit(this);"><?php echo $get['paguanggaran']; ?></td>
                                        </tr>
                        <?php $no++; } ?> 
                    </tbody>
                </table>
    ...
    <script>
		...
		function saveToDatabasekelompok(editableObj,column,id) {
            ...
            if(checkConnection == true){
                $.ajax({
				url: "<?php echo base_url();?>paguanggaran/updatepaguanggaran",
				type: "POST",
